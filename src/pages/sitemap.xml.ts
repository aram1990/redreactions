...
const staticPaths = ['/', '/explore/', '/movies/', '/tv/', '/anime/', '/comics/', '/gaming/', '/trailers/', '/news/', '/reviews/', '/lore/', '/about/', '/authors/', '/contact/', '/privacy/', '/cookies/', '/terms/', '/editorial-policy/', '/copyright/', '/search/'];
